...
const formulario7 = document.querySelector("#form7")
console.log(formulario7);

formulario7.addEventListener("submit", function (e) {
    e.preventDefault();


    console.log("Ejericio 8 Serie 11's")
    for (let i = 0; i < 25; i++) {
        ...
        const serie2 = document.createElement("label");
        serie2.textContent = "-"+S;
        serie.appendChild(serie2);
...
const divmulti = document.querySelector("#multi")
const formulario8 = document.querySelector("#form8")

formulario8.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    for (let i = 0; i < 64; i++) {
        ...
        const multiplos = document.createElement("label");
        multiplos.textContent = "-"+Z;
        divmulti.appendChild(multiplos);
    }
});


const formulario9 = document.querySelector("#form9")
formulario9.addEventListener("submit", function (e) {
    e.preventDefault();
    ...
    const salida9 = document.querySelector("#salida9")
    salida9.textContent = "Los núeros pares fueron: " + pares+ " y los impares fueron: " +impares;
    console.log(NP);
...
// function addElement(Z) {

//     var newLabel = document.createElement("p");
//     var newContent = document.createTextNode(Z);
//     newLabel.appendChild(newContent);

//     //

//     var currentLabel = document.getElementById("multis");
...
//     var currentLabel = document.getElementById("series");
//     document.body.insertBefore(newLabel, currentLabel);
